...
package org.openscience.cdk.render;
...
/**
 * Displays a structure (CDK AtomContainer) in a resizable icon. The icon is
 * drawn transparent and the background should be set in Swing separately.
 *
 * @author John May
 */
